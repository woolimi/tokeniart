...
export interface Art42Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface Art42 extends BaseContract {
  connect(runner?: ContractRunner | null): Art42;
  waitForDeployment(): Promise<this>;

  interface: Art42Interface;
